...
print("Please wait... Reading test data")
...
print("Please wait... Reading train  data")
...
print ("Please wait... Merging the test and train data sets")
...
print("Please wait... Extracting mean and std observations ....")
...
for (i in seq(meansdf[,2])) { 
  meansdf[i,2]<- activity_names[meansdf[i,2],2]   
}

###write the tidy ds meansdf in a textfile & cvs file
print("Please wait... Writing the tidy data set to files tidy_data.txt & tidy_data.csv")
